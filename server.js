...
app.get("/", (req, res) => {
  res.send(`
    <p>endpoints u can try:</p>
    <ul>
      <li><a href="/places">/places</a> – get food places</li>
      <li><a href="/places?search=persian">/places?search=persian</a> – search for persian</li>
      <li><a href="/place-details?place_id=ChIJqSBjesMvK4gRNDQ0s0VHdVs">/place-details?place_id=ChIJqSBjesMvK4gRNDQ0s0VHdVs</a> – details of osmows shawarma</li>
    </ul>
  `);
});
